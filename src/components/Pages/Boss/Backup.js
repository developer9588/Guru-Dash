...
const Backup = () =>{
    ...
    const downloadBackup = () => {
     Axios.get("http://localhost:3001/backup").then(() => {
       console.log("success");
     });
   };
            ...
            <div className="backup-content">
                       ...
                       <div className="restore-content">
                             <div className="restore-choose">
                                  ...
                                  <div className="restore-btn">
                                       <button className="backup-btn" onClick={restoreBackup}>Restore</button>
                                  </div>
                             </div>
                       </div>
                  </div>
                  <div className="backup">
                       ...
                       <div className="backup-content">
                            ...
                            <button className={`backup-btn back-w ${hide ? 'btn-display' : ''} `} onClick={()=>setHide(true),downloadBackup}>Back Up</button>
                       </div>
                  </div>
            </div>
       </div>
